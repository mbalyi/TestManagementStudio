...
export class InMemoryDataService implements InMemoryDbService {
  createDb() {
    ...
    let tests = [
        { id: 1, text: "First programer test", questions: [], owner: null, category: [] },
        { id: 2, text: "Second programer test", questions: [], owner: null, category: [] },
        { id: 3, text: "Exam", questions: [], owner: null, category: [] },
        { id: 4, text: "Test", questions: [], owner: null, category: [] }
    ];
    ...
    let executions = [
        {id: 1, test: null, user: null, answersGiven: [], dateOfStart: new Date(), dateOfFill: null}
    ];

    return { users: users, roles: roles, groups: groups, categories: categories, questions: questions, answers: answers};
  }
}