...
namespace TestManagementStudioService.Models
{
    ...
    public partial class Group : SecuredEntity, IEquatable<Group>
    {
        ...
        public Group(int? Id = default(int?), bool? IsPublic = default(bool?), List<Permission> Permissions = default(List<Permission>), string Name = default(string), List<User> Users = default(List<User>))
        {
            this.Id = Id;
